...
% explain why this research is important, and identify the key
% research question(s) and challenges that have yet to be addressed by
% the community - including limitations of current approaches.

Contemporary distributed systems communication primitives tend to deal
in short-term planning horizons. However, in highly dynamic systems, a
response from an agent may be relevant only for a short period of time
after the response is composed. Hence, follow-up requests will be
relevant for even shorter periods of time, if at all, when they
round-trip back to the agent.

At the same time, agents in highly dynamic systems often cannot freeze
in anticipation of follow-up requests. Instead, we need to expand the
relevance horizon. This may entail: (1) constructing responses such
that they give an indication of not just the current state of an
agent, but also its possible future states, and/or (2) composing
follow-up requests such that they can be serviced successfully,
despite possible change of state of the recipient.

As a particular example, consider the following multi-agent problem: 3
agents roam around in a two-dimensional fixed-size grid, looking for
tasks to do. A task spawns at random, at a random position in the
grid, and neither moves, nor disappears until two robots get within
radius $\omega$ of the task and solve it.
...
% present the main contribution of the research in a way that a
% non-expert could clearly understand, then present the detailed
% objectives of your research, highlighting why your work is novel in
% comparison to existing research.

\section{Methodology and Preliminary Results}

% present the methodology of your approach, discussing why it is
% suitable to your contribution, and also present any preliminary
% results if you have them, including a statement about the current
% status of your work.

\section{Future and Research Plan}

% summarise your intended future work and provide a schedule of
% milestones with a discussion of their feasibility.
