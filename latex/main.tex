...
decentralized\cite{2018-Multi-robot-LTL-Planning-Under-Uncertainty},
...
\begin{align}
\mathtt{help}_B \mathrel{\mathcal{U}} %
  \left( \bigvee_{i=1}^n %
    \mathtt{omw}_i^B \mathrel{\mathcal{U}} %
...
\begin{align}
\mathtt{omw}^B_A \mathrel{\mathcal{U}} %
