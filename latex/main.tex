...
in short-term planning horizons. That is, a response from an agent is
only relevant for a short period of time after the response is
composed. Hence, subsequent requests to the agent, will be relevant
only for an even shorter period of time (if any), when they arrive at
the agent.
